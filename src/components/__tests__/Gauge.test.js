...
describe.only('Gauge', () => {
  ...
  // it('custom test 2', () => {
  //   const component = mount(<Gauge label={{ label: 'Test Label', style: { color: 'blue' } }} color={{"default":"red"}}/>);
  //   const label = component.find(Label);
  //   expect(label).toHaveLength(1);
  //   expect(label.prop('style').color).toBe('blue');
  // });
  ...
  // it('custom test 3', () => {
  //   const component = mount(<Gauge label={{ label: 'Test Label', style: { color: 'blue' } }} color="red"/>);
  //   const label = component.find(Label);
  //   expect(label).toHaveLength(1);
  //   expect(label.prop('style').color).toBe('blue');
  // });
